  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      local servers = {
        ...
        -- I tried this out but it gets in the way of helm template files. I have the helm ls installed so I prefer that
        -- over yamlls and let the yamlls github action act as the linter for that stuff
        -- yamlls = {},
